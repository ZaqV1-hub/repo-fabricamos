...
require_once __DIR__ . '/inc/Addon/ImageOptimization/Database/Tables/ImageOptimization.php'; // CL.
...
$rocket_image                 = new WP_Rocket\Addon\ImageOptimization\Database\Tables\ImageOptimization(); // CL.
