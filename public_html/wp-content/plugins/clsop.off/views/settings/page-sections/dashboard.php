				...
				<fieldset class="wpr-fieldsContainer-fieldset">
					<div class="wpr-field wpr-field--radio">
						...
						<div class="wpr-field-description">
							...
							printf( esc_html__( 'I agree to share anonymous data with the development team to help improve AccelerateWP. %1$sWhat info will we collect?%2$s', 'rocket' ), '<button class="wpr-js-popin">', '</button>' );
							?>
						</div>
					</div>
				</fieldset>
