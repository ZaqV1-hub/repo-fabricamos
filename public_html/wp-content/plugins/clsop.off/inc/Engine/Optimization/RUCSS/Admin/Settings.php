...
class Settings {
	...
	public function display_no_table_notice() {
		...
		$main_message   = esc_html__( '%1$s: Could not create the %2$s table in the database which is necessary for the Remove Unused CSS feature to work.',/* CL Please reach out to %3$sour support%4$s.',*/ 'rocket' ); // CL.
