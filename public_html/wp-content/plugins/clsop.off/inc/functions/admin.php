...
function get_rocket_faq_url() { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals
	...
	$url    = WP_ROCKET_WEB_MAIN . "{$lang}faq/"; // CL.

	/*
	// CL. Temporary off external urls
	return $url;
	*/
}
...
function rocket_data_collection_preview_table() {
	...
	$html .= '<tr>';
	$html .= '<td class="column-primary">';
	$html .= sprintf( '<strong>%s</strong>', __( 'Anonymized AccelerateWP statistics:', 'rocket' ) );
	$html .= '</td>';
	$html .= '<td>';
	$html .= sprintf( '<em>%s</em>', __( 'How AccelerateWP features function and perform.', 'rocket' ) );
	$html .= '</td>';
	$html .= '</tr>';
