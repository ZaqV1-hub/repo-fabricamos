	...
	'optimize_performance' => [
		...
		'plugins' => [
			'clsop/clsop' => [
				...
				'desc'  => __( 'AccelerateWP is the easiest way to make your WordPress website faster and boost your Google PageSpeed score. Get more traffic, better engagement, and higher conversions effortlessly.', 'rocket' ),
				'link'  => '',
			],
			'imagify/imagify'     => [
				'logo'  => [
