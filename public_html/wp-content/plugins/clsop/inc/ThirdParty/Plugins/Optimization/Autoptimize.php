...
class Autoptimize implements Subscriber_Interface {
	...
	public function warn_when_js_aggregation_and_delay_js_active() {
		...
		/* Translators: %1$s is an opening <strong> tag; %2$s is a closing </strong> tag */
			__(
				'%1$sAccelerateWP: %2$sWe have detected that Autoptimize\'s JavaScript Aggregation feature is enabled. AccelerateWP Delay JavaScript Execution will not be applied to the file it creates. We suggest disabling %1$sJavaScript Aggregation%2$s to take full advantage of Delay JavaScript Execution.', // CL.
				'rocket'
			),
			'<strong>',
			'</strong>'
	...
	public function warn_when_aggregate_inline_css_and_cpcss_active() {
		...
		/* Translators: %1$s is an opening <strong> tag; %2$s is a closing </strong> tag */
			__(
				'%1$sAccelerateWP: %2$sWe have detected that Autoptimize\'s Aggregate Inline CSS feature is enabled. AccelerateWP Load CSS Asynchronously will not work correctly. We suggest disabling %1$sAggregate Inline CSS%2$s to take full advantage of Load CSS Asynchronously Execution.', // CL.
				'rocket'
			),
			'<strong>',
			'</strong>'
