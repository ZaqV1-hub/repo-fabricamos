...
class Subscriber implements Subscriber_Interface {
	...
	public function add_interval( $schedules ) {
		...
		$schedules['rocket_saas_pending_jobs'] = [
			'interval' => $interval,
			'display'  => esc_html__( 'AccelerateWP process pending jobs', 'rocket' ),
		];
		...
		$schedules['rocket_remove_saas_failed_jobs'] = [
			'interval' => $interval,
			'display'  => esc_html__( 'AccelerateWP clear failed jobs', 'rocket' ),
		];
		...
		$schedules['rocket_saas_on_submit_jobs'] = [
			'interval' => $interval,
			'display'  => esc_html__( 'AccelerateWP process on submit jobs', 'rocket' ),
		];
