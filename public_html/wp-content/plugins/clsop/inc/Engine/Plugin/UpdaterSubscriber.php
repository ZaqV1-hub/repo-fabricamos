...
class UpdaterSubscriber implements Event_Manager_Aware_Subscriber_Interface {
	...
	const UPDATE_ENDPOINT = 'https://cloudlinux.com/check_update.php';
	...
	public static function get_subscribed_events() {
		return [
			...
			'after_plugin_row_clsop/clsop.php'      => 'display_renewal_notice',
			'admin_print_styles-plugins.php'        => 'add_expired_styles',
			'upgrader_pre_download'                 => [ 'get_download_link', 10, 2 ], // CL.
		];
	}
