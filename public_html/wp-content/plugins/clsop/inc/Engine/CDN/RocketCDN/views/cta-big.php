		...
		<div class="wpr-flex">
			<ul class="wpr-rocketcdn-features">
				...
				<li class="wpr-rocketcdn-cta-footer">
					<a href="https://docs.cloudlinux.com/user-docs/user-docs-shared-pro-cloudlinux/#acceleratewp" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Learn more about CDN', 'rocket' ); ?></a>
				</li>
				<?php if ( ! empty( $data['promotion_campaign'] ) ) : ?>
