...
use WP_Rocket\Addon\ImageOptimization\Database\Tables\ImageOptimization;
...
class WPRocketUninstall {
	 ...
	 * @param ImageOptimization         $awp_image_optimization Image optimization content table.
