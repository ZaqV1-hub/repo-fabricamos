...
$rocket_tutorials = [
	[
		...
		'tutorials' => [
			'7seqacq2ol' => __( 'Getting Started with AccelerateWP', 'rocket' ),
	...
	[
		...
		'tutorials' => [
			'fj7gs031q6' => __( 'How to improve LCP with AccelerateWP', 'rocket' ),
			's599wdduu1' => __( 'How to improve INP with AccelerateWP', 'rocket' ),
			'5wrdzcmj90' => __( 'How to improve CLS with AccelerateWP', 'rocket' ),
		],
	],
	[
