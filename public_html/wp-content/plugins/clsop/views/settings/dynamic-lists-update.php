	...
	<div class="wpr-tools-col">
		...
		<div class="wpr-field-description">
			...
			printf(
				...
				esc_html__( 'Compatibility lists are downloaded automatically every week. Click the button if you want to update them manually.', /* %1$sMore info%2$s',*/ 'rocket' ), // CL.
