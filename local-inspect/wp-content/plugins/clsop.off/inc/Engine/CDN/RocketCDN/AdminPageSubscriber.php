...
class AdminPageSubscriber extends Abstract_Render implements Subscriber_Interface {
	...
	public static function get_subscribed_events() {
		return [
			// 'rocket_dashboard_after_account_data' => 'display_rocketcdn_status', CL.
			'rocket_cdn_settings_fields'        => 'rocketcdn_field',
			'admin_post_rocket_purge_rocketcdn' => 'purge_cdn_cache',
			// 'rocket_settings_page_footer'         => 'add_subscription_modal', CL.
	...
	public function rocketcdn_field( $fields ) {
		...
		$helper_text = __( 'Your CDN subscription is currently active.', 'rocket' );
		...
		$fields['cdn_cnames'] = [
			...
			'helper'      => '', // CL. Temporary off $helper_text . ' ' . $more_info.
			'default'     => '',
	...
	public function add_subscription_modal() {
		...
		$iframe_src = add_query_arg(
			[
				'website'  => home_url(),
				'callback' => rest_url( 'clsop/v1/cdn/' ),
			],
			'https://cloudlinux.com/cdn/iframe'
		);
		?>
