...
<div class="wpr-Popin wpr-Popin-Upgrade">
	...
	<div class="wpr-Popin-content">
		...
		printf( esc_html__( 'You can use AccelerateWP on more websites by upgrading your license. To upgrade, simply pay the %1$sprice difference%2$s between your current and new licenses, as shown below.', 'rocket' ), '<strong>', '</strong>' );
		?>
		</p>
		<p>
		<?php
