...
trait UpdaterApiTools {
	...
	protected function get_request_error( $data = [] ) {
		...
		Logger::debug(
			'Error when reading INI-file.', // CL.
		...
		return new \WP_Error(
			...
			sprintf(
				...
				__( 'An unexpected error occurred. Something may be wrong with external or this server&#8217;s configuration.'/* If you continue to have problems, <a href="%s">contact support</a>.*/, 'rocket' ), // CL.
