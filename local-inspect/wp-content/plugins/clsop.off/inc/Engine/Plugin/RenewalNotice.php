...
class RenewalNotice extends Abstract_Render {
	...
	public function renewal_notice( $version ) {
		...
		$data = [
			'version'     => $major,
			'release_url' => 'https://docs.cloudlinux.com/user-docs/user-docs-shared-pro-cloudlinux/#acceleratewp',
