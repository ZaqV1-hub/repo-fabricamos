...
function rocket_check_key() {
	...
	$response = wp_remote_get(
		'https://cloudlinux.com/valid_key.php',
		[
			'timeout' => 30,
		]
	);
	...
	if ( null === $json ) {
		...
		if ( 'NULLED' === $body ) {
			...
			$message = __( 'License validation failed. You may be using a nulled version of the plugin. Please do the following:', 'rocket' ) . '<ul><li>' . sprintf( __( 'Login to your AccelerateWP %1$saccount%2$s', 'rocket' ), '<a href="https://docs.cloudlinux.com/user-docs/user-docs-shared-pro-cloudlinux/#acceleratewp" rel="noopener noreferrer" target=_"blank">', '</a>' ) . '</li><li>' . __( 'Download the zip file', 'rocket' ) . '<li></li>' . __( 'Reinstall', 'rocket' ) . '</li></ul>' . sprintf( __( 'If you do not have a AccelerateWP account, please %1$spurchase a license%2$s.', 'rocket' ), '<a href="https://cloudlinux.com/" rel="noopener noreferrer" target="_blank">', '</a>' );
			set_transient( 'rocket_check_key_errors', [ $message ] );
		...
		if ( 'BAD_USER' === $body ) {
			// Translators: %1$s = opening link tag, %2$s = closing link tag.
			$message = __( 'License validation failed. This user account does not exist in our database.', 'rocket' ) . '<br>' . sprintf( __( 'To resolve, please contact support.', 'rocket' ), '<a href="https://docs.cloudlinux.com/user-docs/user-docs-shared-pro-cloudlinux/#acceleratewp" rel="noopener noreferrer" target=_"blank">', '</a>' );
			set_transient( 'rocket_check_key_errors', [ $message ] );
		...
		if ( 'USER_BLOCKED' === $body ) {
			// Translators: %1$s = opening link tag, %2$s = closing link tag.
			$message = __( 'License validation failed. This user account is blocked.', 'rocket' ) . '<br>' . sprintf( __( 'Please see %1$sthis guide%2$s for more info.', 'rocket' ), '<a href="https://docs.cloudlinux.com/user-docs/user-docs-shared-pro-cloudlinux/#acceleratewp" rel="noopener noreferrer" target=_"blank">', '</a>' );
			set_transient( 'rocket_check_key_errors', [ $message ] );
	...
	if ( ! $json->success ) {
		$messages = [
			...
			'BAD_NUMBER'  => __( 'You have added as many sites as your current license allows.', 'rocket' ) . '<br>' . sprintf( __( 'Upgrade your %1$saccount%2$s or %3$stransfer your license%2$s to this domain.', 'rocket' ), '<a href="https://docs.cloudlinux.com/user-docs/user-docs-shared-pro-cloudlinux/#acceleratewp" rel="noopener noreferrer" target=_"blank">', '</a>', '<a href="https://docs.cloudlinux.com/user-docs/user-docs-shared-pro-cloudlinux/#acceleratewp" rel="noopener noreferrer" target=_"blank">' ),
			// Translators: %1$s = opening link tag, %2$s = closing link tag.
			'BAD_SITE'    => __( 'This website is not allowed.', 'rocket' ) . '<br>' . sprintf( __( 'Please %1$scontact support%2$s.', 'rocket' ), '<a href="https://docs.cloudlinux.com/user-docs/user-docs-shared-pro-cloudlinux/#acceleratewp" rel="noopener noreferrer" target=_"blank">', '</a>' ),
			// Translators: %1$s = opening link tag, %2$s = closing link tag.
			'BAD_KEY'     => __( 'This license key is not recognized.', 'rocket' ) . '<ul><li>' . sprintf( __( 'Login to your AccelerateWP %1$saccount%2$s', 'rocket' ), '<a href="https://docs.cloudlinux.com/user-docs/user-docs-shared-pro-cloudlinux/#acceleratewp" rel="noopener noreferrer" target=_"blank">', '</a>' ) . '</li><li>' . __( 'Download the zip file', 'rocket' ) . '<li></li>' . __( 'Reinstall', 'rocket' ) . '</li></ul>' . sprintf( __( 'If the issue persists, please %1$scontact support%2$s.', 'rocket' ), '<a href="https://docs.cloudlinux.com/user-docs/user-docs-shared-pro-cloudlinux/#acceleratewp" rel="noopener noreferrer" target=_"blank">', '</a>' ),
		];
