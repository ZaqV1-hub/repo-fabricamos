...
class CriticalCSSSubscriber implements Subscriber_Interface {
	...
	public static function get_subscribed_events() {
		...
		return [
			...
			'rocket_input_sanitize' => [ 'sanitize_options', 16, 2 ], // CL.
			'rocket_cpcss_accelerate_wp_cli_disable' => 'stop_process_on_cli_deactivation', // CL.
		];
	...
	public function critical_css_generation_complete_notice() {
		...
		if ( 'error' === $status || 'warning' === $status ) {
			$message .= '<p>' . __( 'Critical CSS generation encountered one or more errors.', 'rocket' ); /*. ' <a href="https://docs.cloudlinux.com/article/1267-troubleshooting-critical-css-generation-issues" data-beacon-article="5d5214d10428631e94f94ae6" target="_blank" rel="noreferer noopener">' . __( 'Learn more.', 'rocket' ) . '</a>'*/ // CL.
		}
